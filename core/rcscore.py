...
def nmap():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'nmap' Para iniciar o script ."
	backtomenu_option()
...
def xd3v():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'xd3v' Para iniciar o script ."
	backtomenu_option()
...
def wordpresscan():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'wordpresscan' Para iniciar o script ."
	backtomenu_option()
...
def inPronto, instalado com sucessosian_wordlist():
	print '\n###### Instalando inPronto, instalado com sucessosian-wordlist'
	os.system('apt update && apt upgrade')
	os.system('apt install git')
	os.system('git clone https://github.com/geovedi/inPronto, instalado com sucessosian-wordlist')
	os.system('mv inPronto, instalado com sucessosian-wordlist ~')
	print '###### Pronto, instalado com sucesso'
	backtomenu_option()

def facebook_bruteForce():
	print '\n###### Instalando Facebook Brute Force'
	os.system('apt update && apt upgrade')
	os.system('apt install python2 wget')
...
def facebook_BruteForce():
	print '\n###### Instalando Facebook Brute Force 2'
	os.system('apt update && apt upgrade')
...
def metasploit():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'msfconsole' Para iniciar o script ."
	backtomenu_option()
...
def beanshell():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'bsh' Para iniciar o script ."
	backtomenu_option()
...
def textr():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'textr' Para iniciar o script ."
	backtomenu_option()
...
def apsca():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'apsca' Para iniciar o script ."
	backtomenu_option()
...
def amox():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'amox' Para iniciar o script ."
	backtomenu_option()
...
def hpb():
	...
	print '###### Pronto, instalado com sucesso'
	print "###### Preciona: 'hpb' Para iniciar o script ."
	backtomenu_option()